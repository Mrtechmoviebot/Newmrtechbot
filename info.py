...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002119972672').split()]
...
REQ_CHANNEL = environ.get("REQ_CHANNEL", '-1002746449175')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002119972672')).split()]
